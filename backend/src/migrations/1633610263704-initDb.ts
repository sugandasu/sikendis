...
export class initDb1633610263704 implements MigrationInterface {
    name = 'initDb1633610263704'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "kendaraan" ("id" SERIAL NOT NULL, "tipeKendaraan" "kendaraan_tipekendaraan_enum" NOT NULL DEFAULT 'Kendaraan Rutin', "tipeRoda" "kendaraan_tiperoda_enum" NOT NULL DEFAULT 'Roda 4', "kode" character varying NOT NULL, "nama" character varying NOT NULL, "nomorRegister" character varying, "merek" character varying NOT NULL, "ukuranCc" character varying, "bahan" character varying, "tahunPembelian" character varying NOT NULL, "nomorRangka" character varying NOT NULL, "nomorMesin" character varying NOT NULL, "nomorPolisi" character varying, "nomorBpkb" character varying, "asalUsul" "kendaraan_asalusul_enum" DEFAULT 'Pembelian', "warna" character varying, "bahanBakar" "kendaraan_bahanbakar_enum" DEFAULT 'Bensin', "harga" character varying, "foto" character varying, "keterangan" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_33bdbd86afa7a45cfab5658f31e" UNIQUE ("nomorRangka"), CONSTRAINT "UQ_ebb8851b5e78ca8b2f666b9bf6a" UNIQUE ("nomorMesin"), CONSTRAINT "UQ_3e7ad314d9b14e6a2df1e236305" UNIQUE ("nomorPolisi"), CONSTRAINT "UQ_02e2dee984a34b701b5cc8dfed7" UNIQUE ("nomorBpkb"), CONSTRAINT "PK_5e5565ce668c75db361d8a08284" PRIMARY KEY ("id"))`);
